...
- **Careers page** (`Careers.jsx`) fully rebuilt as editorial recruitment publication: asymmetric masthead (We're Hiring notation, inset Join Us, offset statement + rectangular 3px 'See open roles'), expandable 12-row job index, 'What are we?' hinge, 3 distinct career-group treatments (narrow-left eligibility, staggered 2-col hiring process, large 'What we offer:' anchor), geographic colophon offices (vertical 'OUR OFFICES', staggered address blocks, underlined map links). All content/testids preserved.
