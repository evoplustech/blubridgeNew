...
- **Careers page** (`Careers.jsx`) — REBUILT AGAIN per user's final directive (2nd rejection): entire page on a SINGLE warm canvas `#f5f3e9` (NO alternating bands — explicitly in the user's rejection list for this page), lines `#d8d5ca`, header strip+nav `#f5f3e9` borderless on /careers, footer `#f5f3e9` on /careers. Compositions: margin-note We're Hiring (col 1-2) beside inset Join Us (col 3-12); statement+button stacked at col 7-12; hinge with 'What are we?' above indented large description (lg:ml-[8.333%]) and roles heading indented lg:ml-[25%]; eligibility (narrow heading col 1-3, list col 5-10 with short rule); hiring process (heading above, staggered 2-col with progressive row indents md:ml-8/16); What we offer (large anchor col 1-5, cluster col 7-12 pushed down); offices colophon (vertical OUR OFFICES col 1-2, offices at col-starts 2/7/3 with mt offsets). GOTCHA: inline `margin: 0` shorthand overrides Tailwind ml-classes — use marginBottom/marginTop individually.
- **Alternating backgrounds** #f0f1f9/#e8eaf3 applied on Home (hero→work sections), Careers (4 sections), Contact (2 sections + inner colors converted from warm to cool palette). Dark navy CTA sections stay dark. Footer bg: #f0f1f9 on /careers & /contact, #e8eaf3 elsewhere.
