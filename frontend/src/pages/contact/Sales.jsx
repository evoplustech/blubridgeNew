...
const Sales = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f0f1f9]">      {/* Main Contact Section */}
              ...
              <div className="sticky top-32">
                ...
                <div className="mb-8">
                  ...
                  <Link to="/contact/general-enquiry">
                    <button className="flex items-center gap-2 text-white text-sm font-medium px-5 py-2.5 rounded-lg border border-[#d4d8e8] hover:border-blue-500/50 hover:bg-[#e8eaf3] transition-all group">
                      Contact General
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full bg-white border border-[#d4d8e8] rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 transition-colors"
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      required
                      className="w-full bg-white border border-[#d4d8e8] rounded-lg px-4 py-3 text-white focus:outline-none focus:border-blue-500 transition-colors appearance-none cursor-pointer"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    rows={4}
                    className="w-full bg-white border border-[#d4d8e8] rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 transition-colors resize-none"
                ...
                <div className="space-y-4">
                  <label className="flex items-start gap-3 cursor-pointer group">
                    <input
                      ...
                      onChange={handleInputChange}
                      required
                      className="w-5 h-5 rounded border-[#d4d8e8] bg-white text-blue-500 focus:ring-blue-500 focus:ring-offset-0 mt-0.5"
                    />
                ...
                {/* <div className="bg-white border border-[#d4d8e8] rounded-lg p-4 w-fit">
