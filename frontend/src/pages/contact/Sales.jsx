      ...
      <section className="py-20 bg-[#0d0d12]">
        <div className="container-custom">
          ...
          <p className="text-gray-400 mb-12 max-w-3xl">
            Our platform provides everything you need for AI development, from serverless inference to dedicated training clusters.
          </p>

          {/* Service Grid */}
          <div className="grid lg:grid-cols-2 gap-12">
            {/* Left - Service Diagram */}
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-8">
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-white font-medium">Inference</span>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-lg bg-blue-500/10 border border-blue-500/30 flex items-center justify-center">
                      <svg className="w-6 h-6 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="flex items-center gap-4 ml-8">
                  ...
                  <span className="text-white font-medium">GPU Nodes</span>
                </div>
              </div>
            </div>
