...
const services = [
  ...
  return (
    <div className="min-h-screen bg-[#f0f1f9] font-['DM_Sans']">      {/* SECTION 1: Hero Section with Landscape Background and Parallax */}
      ...
      <section className="py-20 bg-[#f0f1f9]">
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              <p className="text-[#2F3A4A] text-sm uppercase tracking-wider mb-2">THE ADVANTAGES OF A</p>
      ...
      <section className="py-12 bg-[#f0f1f9]">
        <div className="container-custom">
            ...
            {relatedContent.map((article, i) => (
              <div key={i} className="bg-slate-900/50 rounded-xl border border-[#d4d8e8]/30 overflow-hidden hover:border-[#d4d8e8]/50 transition-colors cursor-pointer">
                ...
                <div className="p-4">
                  ...
                  <p className="text-xs text-[#2F3A4A] line-clamp-2">{article.excerpt}</p>
                </div>
              </div>
            ))}
          </div>
               ...
               <div className="grid grid-cols-2 gap-4 ">
                {services.map((service, index) => (
                 <Link className="block text-[#243447] hover:text-[#328CC1] transition-colors text-sm" to={service.link}> <div 
                    key={index}
                    className="hover:bg-[#d4d8e8] bg-[#e8eaf3] rounded-xl p-4 border border-[#d4d8e8] hover:border-blue-500/30 transition-colors"
                  >
