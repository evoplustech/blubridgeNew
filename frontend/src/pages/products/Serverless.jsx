...
const Serverless = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f0f1f9] font-['DM_Sans']">      {/* Hero Section with Animated Model Graph - Section 1 */}
      <section className="relative min-h-[550px] flex items-center overflow-hidden bg-[#f0f1f9]">
        ...
        <div className="container-custom">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center md:text-left">
              ...
              <p className="text-[#2F3A4A] text-sm">Our fully optimized stack eliminates the inefficiencies you often pay for elsewhere. You get high-performance serverless at a fraction of the typical cost, with those savings passed directly on to you.</p>
            </div>
            <div className="text-center md:text-left">
              <h3 className="text-lg font-semibold text-[#0B1F3B] mb-2">Engineered for AI workloads</h3>
              <p className="text-[#2F3A4A] text-sm">Get the full cost and performance advantages of our fully integrated stack, purpose-built to support AI workloads at any scale.</p>
            </div>
            <div className="text-center md:text-left">
              <h3 className="text-lg font-semibold text-[#0B1F3B] mb-2">Scale without the overhead</h3>
              <p className="text-[#2F3A4A] text-sm">From testing through to production, scale your AI workloads without bottlenecks or setup but just results.</p>
            </div>
          </div>
        </div>
      </section>
