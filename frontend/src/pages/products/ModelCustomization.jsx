      ...
      <section className="py-20 bg-black">
        <div className="container-custom text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link to="/contact">
              <Button className="bg-white text-black hover:bg-white/90 px-8 py-3 rounded-md font-medium">
                Start Customizing
              </Button>
            </Link>
            <Link to="/contact" className="flex items-center gap-2 px-6 py-3 text-white hover:text-[#328CC1] transition-colors font-medium border border-white/30 rounded-md">
              Contact Us <ArrowRight className="w-4 h-4" />
            </Link>
          </div>
        </div>
