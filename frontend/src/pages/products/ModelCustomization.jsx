...
const ModelCustomization = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fffdf7]">
      ...
      {/* SECTION 3: Accelerated Model Customization - Theme Colors */}
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <div className="space-y-5">
              {/* Pre-configured Card */}
              <div className="bg-[#f3f1e9] rounded-xl p-6 border border-[#E5E7EB]">
                <p className="text-[#6B7280] text-sm mb-1">Ready-to-use Environments</p>
                <h3 className="text-2xl font-semibold text-black mb-2">Pre-configured</h3>
                <p className="text-[#4B5563] text-sm">Fine-tuning and alignment environments ready for immediate use</p>
              </div>
              
              {/* Scalable Card */}
              <div className="bg-[#f3f1e9] rounded-xl p-6 border border-[#E5E7EB]">
                <p className="text-[#6B7280] text-sm mb-1">Distributed GPU Clusters</p>
                <h3 className="text-2xl font-semibold text-black mb-2">Scalable</h3>
                <p className="text-[#4B5563] text-sm">Large-scale adaptation across high-performance infrastructure</p>
              </div>
            </div>
          </div>
        </div>
