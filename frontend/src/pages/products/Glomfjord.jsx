...
const Glomfjord = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F3F1E9] font-['DM_Sans']">      {/* SECTION 1: Hero Section with Glomfjord Data Center Background */}
      <section ref={heroRef} className="relative min-h-[650px] flex items-center overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-3xl" style={{ animation: 'fadeInUp 1s ease-out' }}>
            ...
            <p className="text-[#2F3A4A] text-lg md:text-xl max-w-2xl leading-relaxed mb-8" style={{ animation: 'fadeInUp 1s ease-out 0.4s both' }}>
            ...
            <div className="relative bg-slate-900/50 rounded-xl border border-[#D6DEC3] overflow-hidden aspect-video mb-6">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-[#2F3A4A] text-sm">BBC Storyworks - Transforming Tomorrow</p>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {keyFacts.map((fact, i) => (
              <div key={i}>
                ...
                <p className="text-[#2F3A4A] text-sm leading-relaxed">{fact.description}</p>
              </div>
            ))}
          </div>
        </div>
