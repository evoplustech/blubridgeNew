...
const Careers = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "You can apply directly through our careers page by selecting a role and submitting your application. For general inquiries or if you don't see a suitable role, feel free to send your resume to careers@BluBridge.com. We review every application carefully."
    }
  ];
