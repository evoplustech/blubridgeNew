...
import { useEnquiryForm } from './ai-consulting-5/useEnquiryForm';
import { ContactDetails } from './ai-consulting/ContactDetails';
import { RequirementsSection } from './ai-consulting-5/RequirementsSection';
...
import './ai-consulting-5/AiConsultingVariant5.css';

// This route owns its intro, composition and styles; the base page stays unchanged.
const enquiryHeading = 'Discuss Your AI Requirement';
const enquiryDescription = 'Tell us what you are looking to build, improve or deploy. Share your requirement, estimated budget and contact details. Our team will review your enquiry and contact you to discuss the next steps.';
...
export default function AiConsultingVariant5() {
  ...
  return <section className="aic-fifth-page" data-testid="ai-consulting-5-page">
