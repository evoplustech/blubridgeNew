...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fffdf7] text-[#0B1F3B] font-['DM_Sans']">
      ...
      <section className="py-16 bg-[#fffdf7] overflow-hidden">
        <div className="container-custom flex justify-center items-center">
          <div className="perspective-container" style={{ perspective: '1200px', perspectiveOrigin: '50% 50%' }}>
            <div className="rotating-3d-element">
              {/* 3D Cube/Polyhedron Structure */}
              <div className="cube-3d">
                ...
                <div className="cube-face cube-front">
                  <div className="face-inner">
                    ...
                    <svg viewBox="0 0 100 100" className="face-icon">
                      <polygon points="50,15 85,35 85,65 50,85 15,65 15,35" fill="none" stroke="currentColor" strokeWidth="1.5"/>
                ...
                <div className="cube-face cube-right">
                  <div className="face-inner">
                    <div className="face-glow"></div>
                    <svg viewBox="0 0 100 100" className="face-icon">
                      <rect x="25" y="25" width="50" height="50" fill="none" stroke="currentColor" strokeWidth="1.5" rx="4"/>
        ...
        <style>{`
          ...
          .cube-3d {
            ...
            position: relative;
            transform-style: preserve-3d;
            animation: premiumRotateY 25s cubic-bezier(0.45, 0.05, 0.55, 0.95) infinite;
          }
          ...
          .face-inner {
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, rgba(255,253,247,0.95) 0%, rgba(243,241,233,0.9) 100%);
            border: 1px solid rgba(214, 222, 195, 0.6);
            border-radius: 12px;
            display: flex;
            align-items: center;
            justify-content: center;
            position: relative;
            overflow: hidden;
            box-shadow: inset 0 1px 0 rgba(255,255,255,0.8), inset 0 -1px 0 rgba(0,0,0,0.03);
          }
          ...
          .face-glow {
            ...
            width: 200%;
            height: 200%;
            background: radial-gradient(ellipse at 30% 30%, rgba(50, 140, 193, 0.08) 0%, transparent 50%);
            animation: lightingShift 25s linear infinite;
            pointer-events: none;
          }
          ...
          /* Face positions with true 3D transforms */
          ...
          /* Premium Y-axis rotation with micro-easing */
          @keyframes premiumRotateY {
            0% {
              transform: rotateY(0deg) rotateX(-8deg);
            }
            25% {
              transform: rotateY(90deg) rotateX(-6deg);
            }
            50% {
          ...
          /* Lighting shift synchronized with rotation */
          ...
          .cube-shadow {
            ...
            width: 100px;
            height: 20px;
            background: radial-gradient(ellipse at center, rgba(11, 31, 59, 0.12) 0%, transparent 70%);
            border-radius: 50%;
            transform: translateX(-50%);
            animation: shadowPulse 25s cubic-bezier(0.45, 0.05, 0.55, 0.95) infinite;
          }
