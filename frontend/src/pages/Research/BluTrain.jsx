    ...
    <div className="min-h-screen bg-[#f3f1e9]">
      <div className="max-w-4xl mx-auto px-6 py-12 bg-[#fffdf7]">
        ...
        <div className="prose prose-lg max-w-none text-gray-800" style={{ textAlign: "justify" }}>
          ...
          <div className="my-8">
            <img src="/images/blutrain/figure1-architecture.png" alt="Figure 1: The modular architecture of the BluTrain framework" className="w-full rounded-lg border border-gray-200" />
          </div>
          ...
          <div className="my-8">
            <img src="/images/blutrain/algorithm1-ddp.png" alt="Algorithm 1: Distributed Data Parallel Training Step" className="w-full rounded-lg border border-gray-200" />
          </div>
          ...
          <div className="my-8">
            <img src="/images/blutrain/algorithm2-batch.png" alt="Algorithm 2: Double-Buffered Batch Production" className="w-full rounded-lg border border-gray-200" />
          </div>
          <p className="mb-10">
          ...
          <div className="my-8">
            <img src="/images/blutrain/figure2-gpt2.png" alt="Figure 2: The GPT-2 decoder-only Transformer architecture" className="w-full rounded-lg border border-gray-200" />
          </div>
          <div className="my-6">
            <img src="/images/blutrain/table1-hyperparams.png" alt="Table 1: Training hyperparameters" className="w-full rounded-lg border border-gray-200" />
          </div>
          ...
          <div className="my-8">
            <img src="/images/blutrain/figure3-loss.png" alt="Figure 3: Training and validation loss" className="w-full rounded-lg border border-gray-200" />
          </div>
          ...
          <div className="my-8">
            <img src="/images/blutrain/table2-throughput.png" alt="Table 2: End-to-end training comparison" className="w-full rounded-lg border border-gray-200 mb-6" />
            <img src="/images/blutrain/figure4-throughput.png" alt="Figure 4: Per-step throughput" className="w-full rounded-lg border border-gray-200" />
          </div>
          ...
          <div className="my-8">
            <img src="/images/blutrain/table4-longcontext.png" alt="Table 4: Long-context training" className="w-full rounded-lg border border-gray-200" />
          </div>
          ...
          <div className="my-8">
            <img src="/images/blutrain/tables5-6-largest.png" alt="Table 5: Model configuration and Table 6: Peak memory and throughput" className="w-full rounded-lg border border-gray-200" />
          </div>
