...
export const useEnquiryForm = () => {
  ...
  const handleSubmit = event => {
    ...
    submission.submit({ ...form, formVariant: 'ai-consulting-5', serviceRequirements: selectedRequirements(form), country: countryByCode[form.countryCode].name, phone: parsePhone(form.phone, form.phoneCountry).number }, serverErrors => { setErrors(serverErrors); focusError(serverErrors); });
  };
