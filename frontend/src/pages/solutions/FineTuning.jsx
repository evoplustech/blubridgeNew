        ...
        <div className="container-custom">
          <div className="grid md:grid-cols-3 gap-10 text-center">
            ...
            <div>
              ...
              <p className="text-[#6B7280] text-sm leading-relaxed">
                Easily growing your AI operations without excessive costs. BluBridge’s GPU cloud solutions are built to scale smoothly and are offering flexible pricing that is adapting to your resource needs.
              </p>
            </div>
          </div>
        </div>
