      ...
      <section className="relative min-h-[85vh] flex flex-col overflow-hidden">
        ...
        <div className="container-custom relative z-10 flex-1 flex items-center py-24">
          <div className="max-w-3xl">
            ...
            <p className="text-lg lg:text-xl text-[#2F3A4A] mb-10 leading-relaxed max-w-2xl">BluBridge Cloud offers tailored computing solutions for biotechnology firms and healthcare research organisations. By providing accessible and powerful GPU resources alongside expert AI support, BluBridge enables healthcare teams to speed up research efforts and deliver more personalised treatments.</p>
