      ...
      <section className="py-24 bg-[#000000]">
        <div className="container-custom">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="border-l-2 border-blue-500 pl-6"><h3 className="text-lg font-semibold text-blue-400 mb-2">Drug Discovery</h3><p className="text-[#5B6B7A] text-xs font-medium mb-2 uppercase tracking-wider">Build superior AI models</p><p className="text-[#5B6B7A] text-sm leading-relaxed">Use high-performance GPU computing to accelerate training of large-scale AI models that can predict protein structures and expedite the development of new treatments.</p></div>
            <div className="border-l-2 border-blue-500 pl-6"><h3 className="text-lg font-semibold text-blue-400 mb-2">Life Sciences</h3><p className="text-[#5B6B7A] text-xs font-medium mb-2 uppercase tracking-wider">Accelerated Simulations</p><p className="text-[#5B6B7A] text-sm leading-relaxed">Run complex biological and chemical simulations much faster using GPU-powered infrastructure, enabling deeper investigation and faster results.</p></div>
            <div className="border-l-2 border-blue-500 pl-6"><h3 className="text-lg font-semibold text-blue-400 mb-2">Genomics</h3><p className="text-[#5B6B7A] text-xs font-medium mb-2 uppercase tracking-wider">Personalised medicine</p><p className="text-[#5B6B7A] text-sm leading-relaxed">Analyse vast sets of genomic data to support personalised medicine, helping researchers uncover insights that drive tailored healthcare solutions.</p></div>
            <div className="border-l-2 border-blue-500 pl-6"><h3 className="text-lg font-semibold text-blue-400 mb-2">Bioinformatics</h3><p className="text-[#5B6B7A] text-xs font-medium mb-2 uppercase tracking-wider">Scalable Storage</p><p className="text-[#5B6B7A] text-sm leading-relaxed">Scale storage and computing for the large, complex datasets common in bioinformatics, making data easier to access, process, and secure for research purposes.</p></div>
          </div>
        </div>
      </section>
