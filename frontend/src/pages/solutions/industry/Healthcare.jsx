    ...
    <div className="min-h-screen bg-[#000000]">
      ...
      <section className="py-24 bg-[#000000]">
        <div className="container-custom">
          ...
          <p className="text-base text-white/60 mb-12 max-w-2xl">Blubrg helps organisations throughout the entire AI lifecycle, shortening the time from experimentation to production and improving overall productivity in healthcare AI initiatives.</p>
