      ...
      <section className="py-24 bg-[#f0f1f9]">
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="hover:bg-[#f5f4f1] min-h-[310px] hover:text-[#328CC1] bg-white border border-[#d4d8e8] rounded-xl p-8 hover:border-amber-500/30 transition-colors">
              <div className="mb-6">
            ...
            <div className="hover:bg-[#f5f4f1] hover:text-[#328CC1] bg-white border border-[#d4d8e8] rounded-xl p-8 hover:border-amber-500/30 transition-colors">
              <div className="mb-6">
