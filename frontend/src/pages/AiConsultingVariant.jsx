...
export default function AiConsultingVariant() {
  ...
  return <section className="aic-alt-page" data-testid="ai-consulting-variant-page">
    <div className="aic-alt-layout">
      <aside className="aic-alt-intro-area" data-testid="aic-alt-intro-area">
        <header className="aic-alt-intro" data-testid="aic-alt-sticky-intro">
          <p className="aic-alt-eyebrow" data-testid="aic-eyebrow">GET IN TOUCH</p>
