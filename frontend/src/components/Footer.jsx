...
const Footer = () => {
  ...
  const isLightFooter = location.pathname === '/careers' || location.pathname === '/contact';
  ...
  return (
    <footer style={{ backgroundColor: isLightFooter ? '#f0f1f9' : '#e8eaf3', color: '#0a1230' }} data-testid="site-footer">
          ...
          <div className="lg:col-span-6">
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10">
                <Input type="text" placeholder="First name" value={firstName} onChange={(e) => setFirstName(e.target.value)} className={footerInput} data-testid="footer-first-name" />
                <Input type="text" placeholder="Last name" value={lastName} onChange={(e) => setLastName(e.target.value)} className={footerInput} data-testid="footer-last-name" />
              </div>
              <Input type="email" placeholder="Email Address" value={email} onChange={(e) => setEmail(e.target.value)} className={`${footerInput} mt-3 w-full`} required data-testid="footer-email" />
              <Input type="text" placeholder="Message (optional)" value={message} onChange={(e) => setMessage(e.target.value)} className={`${footerInput} mt-3 w-full`} data-testid="footer-message" />
              <Button
                type="submit"
                disabled={loading}
